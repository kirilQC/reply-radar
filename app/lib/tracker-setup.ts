...
export const CAMPAIGN_TABLE_SPEC: TrackerTableSpec = {
  ...
  fields: [
    ...
    { stage: "base", name: "Total Leads", type: "number", options: wholeNumber, description: "Leads on the campaign's list, the top of the funnel. HeyReach's total-users figure as of the last morning brief." },
